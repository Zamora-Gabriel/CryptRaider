...
#include "CryptRaiderGame/Mover.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeMover() {}
// Cross Module References
	CRYPTRAIDERGAME_API UClass* Z_Construct_UClass_UMover();
	CRYPTRAIDERGAME_API UClass* Z_Construct_UClass_UMover_NoRegister();
...
// End Cross Module References
	...
	template<> CRYPTRAIDERGAME_API UClass* StaticClass<UMover>()
	{
		return UMover::StaticClass();
	}
	DEFINE_VTABLE_PTR_HELPER_CTOR(UMover);
	UMover::~UMover() {}
	struct Z_CompiledInDeferFile_FID_Repos_UnrealProjects_CryptRaider_CryptRaider___copia_CryptRaider_CryptRaiderGame_Source_CryptRaiderGame_Mover_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Repos_UnrealProjects_CryptRaider_CryptRaider___copia_CryptRaider_CryptRaiderGame_Source_CryptRaiderGame_Mover_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UMover, UMover::StaticClass, TEXT("UMover"), &Z_Registration_Info_UClass_UMover, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UMover), 1400648940U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Repos_UnrealProjects_CryptRaider_CryptRaider___copia_CryptRaider_CryptRaiderGame_Source_CryptRaiderGame_Mover_h_4294360863(TEXT("/Script/CryptRaiderGame"),
		Z_CompiledInDeferFile_FID_Repos_UnrealProjects_CryptRaider_CryptRaider___copia_CryptRaider_CryptRaiderGame_Source_CryptRaiderGame_Mover_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Repos_UnrealProjects_CryptRaider_CryptRaider___copia_CryptRaider_CryptRaiderGame_Source_CryptRaiderGame_Mover_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
